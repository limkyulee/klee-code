 ...
 * HTTP 호출과 대화 상태 관리는 AssistantPanel 아래로 위임한다.
 *
 * ┌─ 사용자 흐름 ──────────────────────────────────────────────────┐
...
import { AssistantPanel } from './webview/AssistantPanel';
...
export function activate(context: vscode.ExtensionContext): void {
    const assistantPanel = new AssistantPanel(context.extensionUri);
