...
import { WebviewMessageHandler, type WebviewMessage } from './webviewMessageHandler';

export class AssistantPanel implements vscode.WebviewViewProvider {
    ...
    async askFromInputBox(): Promise<void> {
        await vscode.commands.executeCommand(`${AssistantPanel.viewType}.focus`);
    ...
    resolveWebviewView(webviewView: vscode.WebviewView): void {
        ...
        this.messageHandler = new WebviewMessageHandler((message) => webviewView.webview.postMessage(message));
