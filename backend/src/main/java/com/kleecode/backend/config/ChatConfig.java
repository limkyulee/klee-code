 ...
 * <ul>
 *   <li>어떤 모델(AnthropicChatModel)을 쓸지 — Phase 1 에서 Ollama 토글 추가 예정</li>
...
public class ChatConfig {
     ...
     *
     * @param anthropicChatModel auto-configure 된 Anthropic 모델
     * @param chatMemory         auto-configure 된 MongoDB 기반 메모리
     */
    @Bean
    ChatClient chatClient(AnthropicChatModel anthropicChatModel, ChatMemory chatMemory) {
